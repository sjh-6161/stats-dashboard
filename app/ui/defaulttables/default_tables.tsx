import { FetchTeamBuyDefaults, FetchTeamPistolDefaults } from "@/app/lib/data";
...
export async function DefaultTables() {
    ...
    const buy_defaults = await FetchTeamBuyDefaults(team_name, 20000, 500000);
    const eco_defaults = await FetchTeamBuyDefaults(team_name, 0, 10000);
    const pistol_defaults = await FetchTeamPistolDefaults(team_name)
